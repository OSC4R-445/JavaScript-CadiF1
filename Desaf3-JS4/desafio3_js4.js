...
const showInactivityPrompt = () => {
    ...
    Swal.fire({
        ...
        didOpen: () => {
            // REMOVED: Swal.showLoading(); // This was hiding the confirm button!
...
const showInitialSessionPrompt = () => {
    ...
    Swal.fire({
        ...
        confirmButtonColor: '#3085d6',
        cancelButtonColor: '#d33',
        confirmButtonText: 'Sí, continuar', // This button is crucial for Req 2
        cancelButtonText: 'No, cerrar sesión',
        allowOutsideClick: false,
        allowEscapeKey: false,
        didOpen: () => {
            // No timer or progress bar for this initial alert
            // No Swal.showLoading() here either, it's correct
        },
        willClose: () => {
            isSweetAlertOpen = false; // Reset flag when SweetAlert closes
        }
        ...
        if (result.isConfirmed) {
            ...
            Swal.fire('¡Sesión Continuada!', 'Tu sesión sigue activa.', 'success');
            resetInactivityTimer(); // NOW, start the 15-second inactivity timer (Req 4)
        } else if (result.dismiss === Swal.DismissReason.cancel) {
...
document.addEventListener('DOMContentLoaded', () => {
    ...
    // --- Initial 10-second prompt for session continuation (Req 2) ---
